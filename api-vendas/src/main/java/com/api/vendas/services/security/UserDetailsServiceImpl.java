...
public class UserDetailsServiceImpl implements UserDetailsService{
	...
	private Usuario getUsuario(String username) {
		return repository.findByLogin(username).orElseThrow(() -> new UsernameNotFoundException("Usuario nao encontrado"));
	}
	...
	public TokenDto autenticar(Usuario usuario) {
		...
		throw new RuntimeException("Login/senha invalidos");
